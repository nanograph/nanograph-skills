...
nanograph 1.0 uses Lance v3, which writes datasets in Lance storage format v2.2. Databases created with earlier nanograph versions use Lance format v2. Both formats are readable, but v2.2 is required for new Lance features.
